function mainfunction2withLiverEating2combo()
...
for loop=1:1440
    ...
    [BFotherbloodj, cvectorotherbloodj] = otherblood(BFotherbloodi, cvector1, carbs, calciumintake, sodiumintake, ironintake, Ci, RQ, anemia);
...
function [outflow, Cout] = otherblood(flow, Cin, carbs, calciumintake, sodiumintake, ironintake, Ci, RQ, anemia)
Cout = [];
...
outflow = flow - 0.5;%arbitrarily set bleeding rate to 0.5 mL/min   
end
Cout(1) = Cin(1);
