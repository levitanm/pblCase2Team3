function mainfunction2anemiakindaworks()
...
if anemia == 0
outflow = flow;
bloodweight1=bloodweight;
else
outflow = flow - 0.5;%arbitrarily set bleeding rate to 0.5 mL/min
bloodweight1=bloodweight-0.005*1.056; %track blood loss as by subtracting mass lost from bloodweight
end
Cout(1) = Cin(1);
