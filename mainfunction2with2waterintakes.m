function mainfunction2FUCKINGBROKEN()
...
for loop=1:100
    ...
    [BFkidneyj, cvectorkidneyj, bloodweightout, newBP] = kidney(BFkidneyi, cvectorotherbloodj,RQ,mass, Ci, BP1,bloodweight, basebloodweight);
    BPvec=[BPvec newBP];
...
function [finalbloodflowj, cvectorj, finalbloodweight, finalBP] = kidney(bloodflowi, cvectori, RQ, mass, Ci, BP1, bloodweightin, basebloodweight)
...
newBP=(38.178*log(bloodweightout/basebloodweight)+100);%*(1.8886*(cvectori(1)/cE0)-0.8886);
wateroutagain=(1.389*(0.0003*(newBP)^2-0.0257*newBP+0.57));
waterinagain = 1.389;
finalbloodflowj = bloodflowi + waterinagain - wateroutagain;
finalbloodweight = bloodweightout + (waterinagain-wateroutagain);
finalBP = (38.178*log(finalbloodweight/basebloodweight)+100);
